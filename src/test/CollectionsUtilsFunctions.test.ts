...
// test('choose', () => {
// 	expect( () => cuf.choose({collection: []}) ).toThrow();
// 	expect( () => cuf.choose({collection: a1, exponent: 0}) ).toThrow();

// 	let c1 = cuf.choose({ collection: a1, exponent: 1 });
// 	expect( a1 ).toContain( c1 );
	

// 	let out: number[] = [];
// 	for (let i = 1; i<100000; i++) {
// 		out.push( cuf.choose({collection: n, exponent: 1}) )
// 	}
